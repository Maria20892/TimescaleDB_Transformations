...
DECLARE
    ...
    end_timestamp TIMESTAMP := '2024-11-10 04:00:01.099+01'; --last timestamp in the timeseries that has to be transformed 
    original_id VARCHAR := 'Exp3P1V5happiness_x10_with_gaps'; -- Set the original timeseries_id 
