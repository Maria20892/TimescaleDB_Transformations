...
DECLARE
    ...
    end_timestamp TIMESTAMP := '2024-11-10 04:00:10.999+01'; --last timestamp in the timeseries that has to be transformed 
...
BEGIN
    ...
    WITH new_timeseries AS (
        ...
        SELECT 
	    id || 'NULL_gap_fill_10mlsec', -- Concatenate to the ID
            id,
            type,              
            measure_id,                    
            source,      
...
-- DELETE FROM query_execution_log where query_name LIKE 'x100%';