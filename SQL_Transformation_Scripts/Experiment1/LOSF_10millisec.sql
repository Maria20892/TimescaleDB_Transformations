...
DECLARE
    ...
    original_id VARCHAR := 'Exp3P1V5happiness_with_gaps'; -- Set the original timeseries_id 
...
BEGIN
    ...
    WITH new_timeseries AS (
        ...
        SELECT 
	    id || '__NULL_gap_fill_10mlsec__', -- Concatenate to the ID
            id,
            type,              
            measure_id,                    
            source,      
